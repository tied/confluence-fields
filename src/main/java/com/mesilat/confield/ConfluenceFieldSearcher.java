...
public class ConfluenceFieldSearcher extends AbstractFieldSearcher {
    ...
    public void init(CustomField field) {
        final FieldIndexer indexer = new ConfluenceFieldIndexer(fieldVisibilityManager, field);
        ...
        this.customFieldSearcherClauseHandler = new SimpleCustomFieldContextValueGeneratingClauseHandler(
            new ConfluenceFieldValidator(field, dataService),
            ...
            new ConfluencePageValuesGenerator(field, dataService),
